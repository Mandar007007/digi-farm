            ...
            <div className="">
              <div className=" grid grid-cols-8 ">
                <div className=" col-span-3 border-b border-blue-gray-50 py-3 md:px-6 px-3 ">
                  <p className="block antialiased  font-sans sm:text-[13px] text-[10px] font-bold uppercase text-blue-gray-400">
                    Crops
                  </p>
                </div>
                  ...
                  <>
                    <div className=" grid grid-cols-8">
                      <div className=" col-span-3 py-3 md:px-6 px-3 border-b border-blue-gray-50">
                        <div className=" flex items-center justify-center ">
                          <img
                            ...
                            className="inline-block relative object-cover object-center w-12 h-12 rounded-md mr-5"
                          />
                      ...
                      <div className=" col-span-2 py-3 md:px-6 px-3 border-b border-blue-gray-50 flex items-center justify-center">
                        <p className="block antialiased font-sans text-xs font-normal text-blue-gray-600">
                          800 Rs
                        </p>
                      </div>
