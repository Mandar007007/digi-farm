...
export default function ProfilePage({
  ...
  return (
    <div>
      ...
      <div className="w-[30rem] max-w-full mt-36 py-6 border  rounded-lg shadow glassy-effect flex justify-around align-middle items-center pt-3 pr-4">
        <div>
          <img
            className="md:w-32 md:h-32 h-20 w-20 md:ml-4 mb-3 rounded-full shadow-lg"
            src="/avatar2.jpg"
            alt={user?.name}
          />
        </div>
